...
export default function Button({ variant = 'primary', size = 'md', className, ...rest }: Props) {
  ...
  const variants = {
    primary: 'bg-[var(--cv-primary)] text-white hover:brightness-110',
    secondary: 'bg-[var(--cv-accent)] text-[#0C2B1B] hover:brightness-105',
    ghost: 'border border-[var(--cv-primary)] dark:border-[var(--cv-accent)] text-[var(--cv-primary)] dark:text-[var(--cv-accent)] bg-transparent hover:bg-[color:rgba(14_124_69_/_0.06)] dark:hover:bg-[color:rgba(126_217_163_/_0.06)]',
