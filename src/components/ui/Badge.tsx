...
export function Badge({ intent='neutral', className, ...props }: Props) {
	const map = {
	...
	return <span className={clsx('inline-flex items-center rounded-lg px-2 py-0.5 text-xs font-medium', map[intent], className)} {...props}/>
}
