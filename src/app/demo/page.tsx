		...
		<div className="space-y-8">
			...
			<section className="card p-6 space-y-4">
				...
				<p className="text-sm text-gray-600 dark:text-gray-400">
					Try the <GlossaryTip term="Density" /> toggle in the header (top-right) to switch between compact and comfortable spacing.
					The table below will adjust its padding automatically.
				</p>
			</section>
			...
			<section className="card p-6 space-y-4">
				...
				<p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
					Skeleton placeholders prevent layout shifts during data loading. Click the button to see them in action.
				</p>
				<button
					onClick={() => {
						setIsLoading(true)
			...
			<section className="card p-6 space-y-4">
				...
				<p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
					<GlossaryTip term="Driver chip">Driver chips</GlossaryTip> show factors affecting projections. 
			...
			<section className="card p-6 space-y-4">
				...
				<div className="space-y-2 text-sm">
					...
					<p>
						<GlossaryTip term="Coverage" /> tells you how reliable our predictions have been historically.
					</p>
					<p>
					...
					<Table>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<ReasonChips reasons={[
										{ label: 'Rush usage', effect: 3.1, confidence: 0.89 },
									]} />
								</td>
			...
			<section className="card p-6 space-y-4 bg-green-50 dark:bg-green-900/10">
				...
				<ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
					...
					<li>✓ Tooltip definitions render on hover/focus and are accessible with screen readers</li>
				</ul>
			</section>
		</div>
	)
