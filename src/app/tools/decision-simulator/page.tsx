...
import {
  ...
  getFloor,
  getCeiling,
  type ProjectionWithEnhancement,
    ...
    return projectionsData.data.projections.map((proj) => {
      ...
      const row: Row = {
        ...
        range: {
          ...
          p10: isEnhanced(proj as unknown as ProjectionWithEnhancement)
            ? getFloor(proj as unknown as ProjectionWithEnhancement & { floor?: number }, proj.projection)
            : proj.projection,
          p50: proj.projection,
          p90: isEnhanced(proj as unknown as ProjectionWithEnhancement)
            ? getCeiling(proj as unknown as ProjectionWithEnhancement & { ceiling?: number }, proj.projection)
            : proj.projection,
        },
