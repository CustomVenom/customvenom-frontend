...
- **GOOGLE_CLIENT_SECRET**: `<YOUR_GOOGLE_CLIENT_SECRET>` ✅ (Updated: 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 - set in Vercel)
...
- **GOOGLE_CLIENT_SECRET**: Same as production ✅ (Updated: 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 - set in Vercel)
...
- **GOOGLE_CLIENT_SECRET**: Updated to `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` in Vercel (Production & Preview). Workers API secret must be updated manually in Cloudflare Dashboard.
