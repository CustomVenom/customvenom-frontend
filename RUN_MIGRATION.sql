-- Production Migration: Add Auth Tier/Role Enums
-- Run this in your Neon Postgres database (via Neon Dashboard SQL Editor)
-- This migration is NON-BREAKING - existing users will default to FREE tier
